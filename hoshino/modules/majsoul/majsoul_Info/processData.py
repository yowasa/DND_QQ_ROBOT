...
def chooseID(IDdata):
    ...
    for i in range(0, len(IDdata)):
        message = message + "【" + str(i + 1) + "】" + str(IDdata[i]["nickname"]) + "(" + judgeLevel(
            str(IDdata[i]["level"]["id"])) + ")\n"
...
def processRecordInfo(record, num):
    ...
    for i in range(0, 5):
        ...
        for j in range(0, num):
            message = message + str(data[i]["players"][j]["nickname"]) + "(" + str(
                data[i]["players"][j]["score"]) + ")  "
        message = message + "\n"
...
def judgeLevel(level):
    if level == "10203" or level == "20203":
        return "雀士三"
    elif level == "10301" or level == "20301":
        return "雀杰一"
    elif level == "10302" or level == "20302":
        return "雀杰二"
    elif level == "10303" or level == "20303":
        return "雀杰三"
    elif level == "10401" or level == "20401":
        return "雀豪一"
    elif level == "10402" or level == "20402":
        return "雀豪二"
    elif level == "10403" or level == "20403":
        return "雀豪三"
    elif level == "10501" or level == "20501":
        return "雀圣一"
    elif level == "10502" or level == "20502":
        return "雀圣二"
    elif level == "10503" or level == "20503":
        return "雀圣三"
    elif level == "10601" or level == "20601":
        return "魂天"
