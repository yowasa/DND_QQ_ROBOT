...
svtw = Service('pcr新闻订阅-台服', bundle='pcr订阅',enable_on_default=False, help_='[台服新闻]台服官网新闻\n')
svbl = Service('pcr新闻订阅-b服', bundle='pcr订阅',enable_on_default=False, help_='[b服新闻]B服官网新闻\n')
...
@svtw.scheduled_job('cron', hour='*/3', jitter=20)
async def sonet_news_poller():
    await news_poller(SonetSpider, svtw, '台服官网')


@svbl.scheduled_job('cron', hour='*/3', jitter=20)
